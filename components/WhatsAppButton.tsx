...
export default function WhatsAppButton(): JSX.Element {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex items-center gap-3">
      {hovered && (
        <div
          className="text-white text-xs px-4 py-2 rounded-xl whitespace-nowrap"
          style={{
      ...
      <div
        ...
        className="w-14 h-14 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110"
        style={{
